...
bigname="/content/drive/MyDrive/LLMs_weight/llama/checkpoints/Llama-2-7b-hf"
...
def build_dataset_rank(
    ...
    ds = load_dataset('json', data_files="/content/ShareGPT_Vicuna_unfiltered/ShareGPT_V4.3_unfiltered_cleaned_split.json")
    ds = ds['train']
